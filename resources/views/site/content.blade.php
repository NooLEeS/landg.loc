        ...
        <div class="container">
            ...
            <div class="team_section clearfix">
                @foreach($peoples as $k=>$people)
                    <div class="team_area">
                        <div class="team_box wow fadeInDown delay-03s{{($k*3+3)}}">
                            <div class="team_box_shadow"><a href="javascript:void(0)"></a></div>

                            {{Html::image('assets/img/'.$people->images,$people->name)}}

                        </div>
                        <h3 class="wow fadeInDown delay-03s($k*3+3)">{{$people->name}}</h3>
                        <span class="wow fadeInDown delay-03s($k*3+3)">{{$people->position}}</span>
                        <p class="wow fadeInDown delay-03s($k*3+3)">{{$people->text}}</p>
                    </div>
                    @endforeach
